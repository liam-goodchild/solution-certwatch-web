...
export function ReminderSettings({ initial, onSaved }: Props) {
  ...
  async function handleSave(e: React.FormEvent) {
    ...
    try {
      ...
      const updated = await api.reminders.updatePreferences({
        ...prefs,
  ...
  return (
    ...
    >
      ...
      {prefs.emailEnabled && (
        ...
        >
          ...
          <span style={{ fontSize: "0.75rem", color: "#6b7280" }}>
            e.g. &quot;30, 14, 7&quot; &mdash; sends emails 30, 14, and 7 days
            before expiry
          </span>
        </div>
      )}
      ...
      >
        SMS reminders are not yet available but will be added in a future
        update.
      </div>
      ...
      {message && (
        <div
          style={{
            fontSize: "0.875rem",
            color:
              message.startsWith("Test email sent") ||
